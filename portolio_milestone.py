...
a3 = a1.copy()
a4 = a1.copy()
expected_arr = sorted(a1)

print(f"Original list: {a1}")
print(f"Expected sorted array: {expected_arr}")
bubble_sort(a1)
print(f"Bubble Sort Results: {a1}")
merge_sort(a2, 0, (len(a2)-1))
print(f"Merge Sort Results: {a2}")
selection_sort(a3)
print(f"Selection Sort Results: {a3}")
insertion_sort(a4)
print(f"Insertion Sort Results: {a4}")